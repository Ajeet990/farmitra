<div>
    ...
    <div class="tw-flex tw-font-bold tw-justify-between tw-items-center tw-p-2">
        <h1>Edit Employee</h1>
        <a href="{{ route('list.employee') }}" class="tw-bg-blue-700 tw-px-2 tw-py-1 tw-text-white  tw-rounded-md"><-- Back</a>
    </div>
    {{-- grid --}}
    <form>
    <div class="tw-grid tw-grid-cols-3  tw-gap-5 tw-bg-white tw-p-4">
        ...
        <div class="  ">
           ...
           <span class="tw-text-red-500 tw-text-xs tw-mt-3 tw-block ">{{ $message }}</span>
         @enderror
         <img src="{{ URL::to('storage/'.$profile_photo_url) }}" alt="" class="tw-h-10">
        </div>
        <div class="  ">
           <p>aadhar_number</p>
        ...
        <div class="  ">
           ...
           <span class="tw-text-red-500 tw-text-xs tw-mt-3 tw-block ">{{ $message }}</span>
         @enderror
         <img src="{{ URL::to('storage/'.$aadhaar_front_upload_url) }}" alt="" class="tw-h-10">
        </div>
        <div class="  ">
           ...
           <span class="tw-text-red-500 tw-text-xs tw-mt-3 tw-block ">{{ $message }}</span>
         @enderror
         <img src="{{ URL::to('storage/'.$aadhaar_back_upload_url) }}" alt="" class="tw-h-10">
        ...
        <div class="  ">
           ...
           <span class="tw-text-red-500 tw-text-xs tw-mt-3 tw-block ">{{ $message }}</span>
         @enderror
         <img src="{{ URL::to('storage/'.$pan_upload_url) }}" alt="" class="tw-h-10">
        </div>
        <div class="  ">
           <p>address</p>
