<div>
    ...
    <div class=" tw-flex tw-font-bold tw-justify-between tw-items-center tw-p-2">
        <h1>Edit Employee Bank Details</h1>
      ...
      <div class="tw-my-2">
        <button type="submit" wire:click.prevent="update" class="tw-w-full tw-text-white tw-bg-blue-700 tw-rounded-md tw-py-2">Save</button>
      </div>
</div>
