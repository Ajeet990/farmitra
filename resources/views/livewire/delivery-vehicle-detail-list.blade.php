<div>
    ...
    @endif
    <h1>Delivery Vehicle Details List</h1>
       ...
       <div class="tw-flex tw-justify-content-end tw-items-center">
          <div class="">
            <input type="text" wire:model.live="search"
              placeholder="Search by vehicle_name or type"
              class="border rounded px-4 py-2 w-full"/>
          </div>
          <a href="{{ route("add.delivery.vehicle.detail") }}" class="tw-bg-blue-700 tw-px-2 tw-py-1 tw-text-white  tw-rounded-md tw-whitespace-nowrape">Add +</a>
       </div>
    </div>
    <div class="tw-overflow-x-auto wt-mt-2">
        <table class="tw-min-w-full tw-divide-y tw-divide-gray-200">
          ...
          <tbody class="tw-bg-white tw-divide-y tw-divide-gray-200">
            @foreach ($deliveryVehicleDetails as $item)
            <tr>
                <td class="tw-px-6 tw-py-4 tw-whitespace-nowrap">{{ $loop->index+1 }}</td>
                <td class="tw-px-6 tw-py-4 tw-whitespace-nowrap">{{ $item->vehicle_name }}</td>
                ...
                <td>
                    <a href="{{ route('edit.delivery.vehicle.detail',$item->id )}}" class="tw-bg-green-100 tw-text-blue-800 tw-text-xs tw-font-semibold tw-px-2 tw-rounded-full tw-uppercase ">edit</a>
