<div class="p-5">
    <div class="flex items-center justify-between">
        ...
        <button wire:click='submit' class="py-2 px-10 rounded-md bg-primary font-medium text-white">Save</button>
    </div>
        ...
        <div class="md:col-span-2">
            ...
            {{-- <div class=" bg-white shadow-main mt-10 dark:bg-bg_dark rounded-md  h-max p-5">
                ...
                <div class="grid grid-cols-2 gap-x-10 ">
                    <div class="mt-4">
                        <label for="" class="dark:text-gray-300">Varient Name</label>
                        <input wire:model.live='varient_name' type="text"
                            class="w-full mt-2 rounded-md bg-transparent dark:placeholder:text-gray-300" name="" id=""
                            placeholder="Enter Product Name">
                    </div>
                    <div class="mt-4">
                        <label for="" class="dark:text-gray-300">SKU (Stock keeping unit
                            )</label>
                    ...
                    <div class="mt-3">
                        <label for="" class="dark:text-gray-300">Price</label>
                        <input wire:model.live='price' type="number"
                            class="w-full mt-2 rounded-md bg-transparent dark:placeholder:text-gray-300" name="" id=""
                            placeholder="Enter Product Price">
                    </div>
                    <div class="mt-3">
                        <label for="" class="dark:text-gray-300">Offer Price </label>
                        <input wire:model.live='offer_price' type="number"
                            class="w-full mt-2 rounded-md bg-transparent dark:placeholder:text-gray-300" name="" id=""
                            placeholder="Enter Offer Price">
                    </div>
                    <div class="mt-3">
                        <label for="" class="dark:text-gray-300">Stock</label>
                        <input wire:model.live='stock' type="number"
                            class="w-full mt-2 rounded-md bg-transparent dark:placeholder:text-gray-300" name="" id=""
                ...
                <div class="grid grid-cols-2 gap-x-10 mt-4 items-end">
                    <div>
                        ...
                        <input wire:model.live="variants.{{ $index }}.variant_name" type="text"
                            class="w-full mt-2 rounded-md bg-transparent dark:placeholder:text-gray-300"
                            placeholder="Enter Product Name">
                    ...
                    <div class="mt-4">
                        ...
                        <input wire:model.live="variants.{{ $index }}.price" type="text"
                            class="w-full mt-2 rounded-md bg-transparent dark:placeholder:text-gray-300"
                            placeholder="Enter Product Price">
                    </div>
                    <div class="mt-4">
                        <label class="dark:text-gray-300">Offer Price</label>
                        <input wire:model.live="variants.{{ $index }}.offer_price" type="text"
                            class="w-full mt-2 rounded-md bg-transparent dark:placeholder:text-gray-300"
                            placeholder="Enter Offer Price">
                    </div>
                    <div class="mt-4">
                        <label class="dark:text-gray-300">Stock</label>
                        <input wire:model.live="variants.{{ $index }}.stock" type="text"
                            class="w-full mt-2 rounded-md bg-transparent dark:placeholder:text-gray-300"
                            placeholder="Enter Stock">
                    </div>
                    @if ($index>0)
