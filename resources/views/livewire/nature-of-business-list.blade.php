<div>
    ...
    <div class="tw-flex tw-font-bold tw-justify-between tw-items-center tw-p-2">
      ...
      <div class="tw-flex tw-justify-content-end tw-items-center">
         ...
         <a href="{{ route("add.natureOfBusiness") }}" class="tw-bg-blue-700 tw-px-2 tw-py-1 tw-text-white  tw-rounded-md tw-whitespace-nowrape">Add +</a>
      </div>
   </div>
        ...
        <table class="tw-min-w-full tw-divide-y tw-divide-gray-200">
          ...
          <tbody class="tw-bg-white tw-divide-y tw-divide-gray-200">
            ...
            <tr>
                ...
                <td>
                    <a href="{{ route('edit.natureOfBusiness',$item->id )}}" class="tw-bg-green-100 tw-text-blue-800 tw-text-xs tw-font-semibold tw-px-2 tw-rounded-full tw-uppercase ">edit</a>
