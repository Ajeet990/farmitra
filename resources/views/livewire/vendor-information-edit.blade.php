<div>
    ...
    <div class="tw-grid tw-grid-cols-4  tw-gap-5 tw-bg-white tw-p-4">
        ...
        <div class="  ">
            ...
            <span class="tw-text-red-500 tw-text-xs tw-mt-3 tw-block ">{{ $message }}</span>
          @enderror
          <img src="{{ URL::to('storage/'.$store_logo_url) }}" class="tw-h-10" alt="">
         </div>
        <div class="  ">
            <p>store_banner</p>
            ...
            <span class="tw-text-red-500 tw-text-xs tw-mt-3 tw-block ">{{ $message }}</span>
          @enderror
          <img src="{{ URL::to('storage/'.$store_banner_url) }}" class="tw-h-10" alt="">
         </div>
        ...
        <div class="  ">
           ...
           <span class="tw-text-red-500 tw-text-xs tw-mt-3 tw-block ">{{ $message }}</span>
         @enderror
         <img src="{{ URL::to('storage/'.$store_inside_photo_url) }}" class="tw-h-10" alt="">
        </div>
        <div class="  ">
           ...
           <span class="tw-text-red-500 tw-text-xs tw-mt-3 tw-block ">{{ $message }}</span>
         @enderror
          <img src="{{ URL::to('storage/'.$store_outside_photo_url) }}" class="tw-h-10" alt="">
        </div>
        <div class="  ">
           <p>store_stamp</p>
