                        ...
                        <div
                            ...
                            <div class="sm:col-span-2 md:grow">
                                <div class="flex justify-end gap-x-2">
                                    <div>
                                        {{-- <button type="button"
                                            wire:click="$dispatch('openModal', { component: 'add-brand' })"
                                            class="m-1 ms-0 py-1.5 px-4 inline-flex items-center gap-x-2 text-sm font-medium rounded-md border border-transparent bg-primary text-white hover:bg-primary/90 disabled:opacity-50 disabled:pointer-events-none">
