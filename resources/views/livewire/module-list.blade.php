    ...
    <h1>Module List</h1>
       ...
       <div class="tw-flex tw-font-bold tw-justify-between tw-items-center tw-p-2">
        ...
        <div class="tw-flex tw-justify-content-end tw-items-center">
           ...
           <a href="{{ route("add.module") }}" class="tw-bg-blue-700 tw-px-2 tw-py-1 tw-text-white  tw-rounded-md tw-whitespace-nowrape">Add +</a>
        </div>
     </div>
        ...
        <table class="tw-min-w-full tw-divide-y tw-divide-gray-200">
          ...
          <tbody class="tw-bg-white tw-divide-y tw-divide-gray-200">
            ...
            <tr>
                ...
                <td class="tw-px-6 tw-py-4 tw-whitespace-nowrap"><img src="{{ URL::to('storage/'.$item->icon)}}" class="tw-h-8"></td>
                <td class="tw-px-6 tw-py-4 tw-whitespace-nowrap">{{ $item->is_active }}</td>
                <td>
                    <a href="{{ route('edit.module',$item->id )}}" class="tw-bg-green-100 tw-text-blue-800 tw-text-xs tw-font-semibold tw-px-2 tw-rounded-full tw-uppercase ">edit</a>
